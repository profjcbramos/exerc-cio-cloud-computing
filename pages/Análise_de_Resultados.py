...
# Remove descrições incompletas (ex: "Recon ..." mas mantém "Reconhecer ...")
descritores_info = descritores_info[
    ~descritores_info["NM_DESCRITOR"].str.match(r"^Recon\s", na=False)
]
